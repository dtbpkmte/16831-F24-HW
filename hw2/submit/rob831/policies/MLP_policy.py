...
class MLPPolicyPG(MLPPolicy):
    ...
    def update(self, observations, actions, advantages, q_values=None):
        ...
        for i in range(self.n_grad_steps):
            policy_loss = torch.mean(-advantages * self.forward(observations).log_prob(actions))
        ...
        if self.nn_baseline:
            ...
            baseline_loss = self.baseline_loss(self.baseline(observations).squeeze(), q_values_normalized)
