...
class PG_Trainer(object):
    ...
    def __init__(self, params):
        ...
        agent_params = {**computation_graph_args, **estimate_advantage_args, **train_args,
                        'n_grad_steps': params['n_grad_steps']}
        ...
        self.params['n_envs'] = params['n_envs']
...
def main():
    ...
    # q9
    parser.add_argument('--n_grad_steps', type=int, default=1)
...
##################################
    ...
    print(f'\033[93mTraining took {end_time - start_time} seconds\033[0m')
